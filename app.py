...
def add_ticker():
    ...
    if string:
        if string == "clear":
            ...
            watch_list.append(string.upper())
...
def refresh_tickers(strtickers):
    tickers = strtickers.split(',')
    l = [t.upper() for t in tickers ]
    parser.populate(l)
    global watch_list
    for ticker in l:
